...
export default function UpdateDrivers({component_data, className = ''}) {

    const { data, setData, patch, errors, processing } =
        useForm({
            name: component_data.driver.first_name || '',
            surname: component_data.driver.last_name || '',
            age: component_data.driver.age || '',
            gender: component_data.driver.gender || '',
            marital_status: component_data.driver.marital_status || '',
            license_number: component_data.driver.license_number || '',
            license_state: component_data.driver.license_state || '',
            license_status: component_data.driver.license_status || '',
            effective_date: component_data.driver.effective_date || new Date(),
            expiration_date: component_data.driver.expiration_date || new Date(),
            license_class: component_data.driver.license_class || ''
        });
    ...
    const submit = (e) => {
        ...
        patch(route('update-driver', component_data.driver));
    };
